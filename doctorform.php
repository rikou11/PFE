...
if (empty($_POST["email"])) {
    $err_email = "Email is required";
     ...
     $select= mysqli_query($con,"SELECT id FROM medecin WHERE email ='".$_POST['email']."'")
     or exit(mysqli_error($con));
...
$query = "INSERT INTO medecin (last_name,first_name,email,password,phone,id_medcin )VALUE('$lname','$fname','$email','$password','$phone','$hospitalid' )";
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="hospitalid" id="re_pass" placeholder="Your KindlyCare id " required/>
                            ...
                            <div class="form-group" style="
                                ...
                                <label for="agree-term" class="label-agree-term"><span><span></span></span>je suis d'acord avec toutes les <a href="privacy&policy" class="term-service">Privacy Policy</a></label>
                            </div>
                            <div class="form-group" >
                    ...
                    <div class="signup-image">
                        <figure><img src="Doctor form/images/undraw_doctor_kw5l.svg" alt="sing up image"></figure>
