...
$del=  mysqli_query ($con,"UPDATE consultation SET `congMalade` =  '".$b."' WHERE id = $id  ");
...
<!--     <h5 class="card-title">Letre d'orientation</h5>
 -->    <h6 class="card-subtitle mb-2 text-muted">Pour MR(s)  <?php echo $row["first_name"] ?> <?php echo $row["last_name"] ?>  </h6>
    <p class="card-text"> <?php echo $row["congMalade"]?></p>

<!--     <a href="#" class="card-link btn btn-success"> Bien Recu !</a>
 -->    <a href="listCongMalade.php?delete=<?php echo $row["id"];  ?>" class="card-link  btn btn-danger" name="delete">supprimer</a>
  </div>
</div>
