...
$del=  mysqli_query ($con,"UPDATE consultation SET `newOrient` =  '".$b."' WHERE id = $id  ");
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0/css/bootstrap.min.css" />
     ...
     <title>lettre Orientaiton</title>
 </head>
 <body>
 <!-- nav -->
...
<!--     <h5 class="card-title">Letre d'orientation</h5>
 -->    <h6 class="card-subtitle mb-2 text-muted">Pour MR(s)  <?php echo $row["first_name"] ?> <?php echo $row["last_name"] ?>  </h6>
    <p class="card-text"> <?php echo $row["newOrient"]?></p>

<!--     <a href="#" class="card-link btn btn-success"> Bien Recu !</a>
 -->    <a href="listOrient.php?delete=<?php echo $row["id"];  ?>" class="card-link  btn btn-danger" name="delete">supprimer</a>
  </div>
</div>
