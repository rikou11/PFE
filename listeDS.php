...
<li class="nav-item">
        <a class="nav-link" href="listeDSinfo.php"><i class="fas fa-info-circle"></i> consulter infos patients</a>
      </li>
    </ul>
...
<a href="listeDS.php?delete=<?php echo $row["id"];  ?>"  class="btn btn-danger btn-sm">x</a>
