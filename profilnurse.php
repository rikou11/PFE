		...
		<div class="account-settings">
			<div class="user-profile">
				<div class="user-avatar">
					<img src="imgs/nu.png" alt="Maxwell Admin">
				</div>
				<h5 class="user-name">Infermier <?php echo $row["first_name"] ?>  </h5>
	...
	<div class="card-body">
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<h6 class="mb-2 text-primary">informations personel</h6>
			</div>
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="name" class="form-control" id="Street" placeholder="<?php echo $row["id_infermier"] ?>" readonly>
				</div>
			</div>
