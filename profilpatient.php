...
$a =mysqli_real_escape_string($con,$_SESSION['email']);
 ...
 /*select for table  */
 $sql = "SELECT * FROM patient WHERE `email` ='".$a."'  ";
...
method="post" class="form-inline my-2 my-lg-0">
  ...
  <button type="submit" name="logout" class="btn btn-outline-danger">  Deconnecter
  </button>
  </form>
</div>
...
<div class="container"><form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
		...
		<div class="account-settings">
			<div class="user-profile">
				<div class="user-avatar">
					<img src="imgs/user.svg" alt="Maxwell Admin">
				</div>
	...
	<div class="card-body">
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<h6 class="mb-2 text-primary">Information personel</h6>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="phone" placeholder="<?php echo $row["age"] ?> " readonly>
				</div>
			</div>
		</div>
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="Street">Wilaya/Cité/rue</label>
					<input type="name" class="form-control" id="Street" placeholder="<?php echo $row["adresse"] ?>" readonly>
				</div>
			</div>
